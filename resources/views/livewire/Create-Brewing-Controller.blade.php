<div>
    <div class="mt-4 px-4">
        <form class="flex flex-col  text-sm text-gray-500 uppercase bg-gray-100 rounded mt-4" method="POST" wire:submit="store">
            @csrf
            ...
            <div class="p-4 w-full">
                <label class="font-semibold text-gray-500" for="type">Type</label>
                <input type="text"
                    class="flex items-center h-8 px-2 w-full bg-gray-100 mt-2 rounded focus:outline-none focus:ring-2"
            ...
            <div class="flex flex-col p-4 w-lg">
                ...
                <input type="text"
                    class="flex items-center h-8 px-2 w-full bg-gray-100 mt-2 rounded focus:outline-none focus:ring-2"
                    value="{{ Carbon\Carbon::today()->format('d/m/Y') }}" name="date_start">
            </div>
            <div class="p-4 w-full">
