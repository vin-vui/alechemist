<div class="pb-20">
    ...
    <div class="bg-white sticky sm:top-0 top-12 px-4 py-2.5 flex justify-between items-center shadow-lg z-30">
        ...
        <h2 class="text-lg font-semibold tracking-widest truncate font-shangrila-caps">{{ __('Recipes') }}</h2>
        <div class="size-6">
            <span class="bg-gray-100 text-gray-600 px-2 py-1 rounded font-shangrila-caps">{{ count($this->recipes) }}</span>
        </div>
    </div>
    ...
    <div class="fixed bottom-8 right-8 shadow-xl">
        <a href="{{ route('fileUpload') }}" class="btn-yellow">
            ...
            <span>{{ __('Import New Recipe') }}</span>
        </a>
    </div>
            ...
            <div class="max-w-full flex gap-4">
                ...
                <div class="flex flex-col truncate mr-4 py-2">
                    ...
                    <div class="mt-2">
                        ...
                        @endif
                        <span class="text-sm text-gray-400">{{ Str::plural(__('Brewing'), $brewings) }} {{ __('in progress') }}</span>
                    </div>
                </div>
            </div>
        </a>
