<div class="mx-4">
    <div class="flex flex-col gap-4  lg: pt-4 pb-12">
        ...
        <div class="flex w-2/3 items-center bg-gray-50 shadow-lg">
            ...
            <div class="flex flex-col w-2/3  text-gray-800">
                <div class="flex justify-between">
                    <div class="font-semibold ">Method</div>
                    <div class="font-normal">{{ $recipe->method }}</div>
                </div>
                <div class="flex justify-between">
                    <div class="font-semibold">Volume</div>
                    <div class="font-normal">{{ $recipe->volume }} l</div>
                </div>
                <div class="flex justify-between">
                    <div class="font-semibold">Ferment</div>
                    <div class="font-normal">{{ $recipe->ferment }}</div>
                </div>
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500">
                <thead class="text-xs text-gray-800 uppercase bg-old-gold">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Minutes</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($recipe->steps as $step)
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-4 py-3">{{ $step->time }} </td>
                            @endif
                        </tr>
                    @endforeach
                </tbody>
        ...
        <div class="flex items-center gap-x-2 py-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M21 13h-6.6l4.7 4.7l-1.4 1.4l-4.7-4.7V21h-2v-6.7L6.3 19l-1.4-1.4L9.4 13H3v-2h6.6L4.9 6.3l1.4-1.4L11 9.6V3h2v6.4l4.6-4.6L19 6.3L14.3 11H21v2Z"/>
            </svg>
            <span>Miscs</span>
        </div>
        <div class="pb-4">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    @foreach ($recipe->steps as $step)
                        <tr class="bg-white border-b">
                            @if($step->type == 'Yeast' || $step->type == 'Dry Hop' || $step->type == 'Aroma')
                            <td class="px-4 py-3">{{ $step->quantity }} </td>
                            <td class="px-4 py-3">{{ $step->unit }} </td>
                            <td class="px-4 py-3">{{ $step->field }} </td>
                            <td class="px-4 py-3">{{ $step->type }} </td>
