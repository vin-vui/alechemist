<x-app-layout>
    ...
    <div class="bg-white sticky sm:top-0 top-12 px-4 py-2.5 flex justify-between items-center shadow-lg z-30">
        ...
        <h2 class="text-lg font-semibold tracking-widest truncate font-shangrila-caps">Import File</h2>
    ...
    <div class="relative z-10">
        <form class="flex flex-col text-sm bg-white py-4 md:min-h-screen justify-between -mt-12" action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-2 flex justify-center rounded-lg border-2 border-dashed border-gray-900/25 px-6 py-10">
                    <div class="text-center">
                        <div class="mt-4 flex text-sm leading-6 text-gray-600">
                            <label for="file" class="relative cursor-pointer rounded-md bg-white font-semibold text-old-gold focus-within:outline-none focus-within:ring-2 focus-within:ring-old-gold focus-within:ring-offset-2">
                                <img class="size-48" src="/pictures/upload-hop.webp" alt="">
                                <span>Upload a file</span>
                                <input name="file" id="file" type="file" accept=".xml" class="sr-only">
                            </label>
                        </div>
            ...
            <div class="flex justify-between gap-x-1 px-8 mt-2 fixed md:relative bottom-8 mx-auto w-full ">
                <a href="{{ route('recipes.index') }}" class="bg-transparent border-2 border-tawny transition-all duration-300 py-1 px-3 flex items-center gap-1 justify-center">
