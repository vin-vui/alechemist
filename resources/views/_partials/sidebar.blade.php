        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
                <ul role="list" class="-ml-2 space-y-1">
                    <li>
                        <a href="{{ route('alechemist.home') }}" class="{{ request()->routeIs('alechemist.home') ? 'text-rich-black bg-anti-flash-white' : 'text-white hover:text-rich-black hover:bg-anti-flash-white' }} group flex gap-x-3 p-2 text-sm leading-6 font-semibold" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-gray-50 text-rich-black&quot;, Default: &quot;text-white hover:text-rich-black hover:bg-anti-flash-white&quot;">
                            <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('alechemist.home') ? 'text-xanthous' : 'text-tawny group-hover:text-xanthous' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        @php
                            $test_route = request()->routeIs('recipes.*') || request()->routeIs('brewing.*') || request()->routeIs('preparation') || request()->routeIs('mash') || request()->routeIs('boil') || request()->routeIs('yeast') || request()->routeIs('ferment') || request()->routeIs('completed') || request()->routeIs('note');
                        @endphp
                        <a href="{{ route('recipes.index') }}" class="{{ $test_route ? 'text-rich-black bg-anti-flash-white' : 'text-white hover:text-rich-black hover:bg-anti-flash-white' }} group flex gap-x-3 p-2 text-sm leading-6 font-semibold" x-state-description="undefined: &quot;bg-gray-50 text-rich-black&quot;, undefined: &quot;text-white hover:text-rich-black hover:bg-anti-flash-white&quot;">
                            <svg class="h-6 w-6 shrink-0 {{ $test_route ? 'text-xanthous' : 'text-tawny group-hover:text-xanthous' }}" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
            ...
            <li class="mt-auto">
                <ul role="list" class="-ml-2 mt-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('profile.show') }}" class="text-white hover:text-rich-black hover:bg-anti-flash-white group flex gap-x-3 p-2 text-sm leading-6 font-semibold" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-gray-50 text-rich-black&quot;, Default: &quot;text-white hover:text-rich-black hover:bg-anti-flash-white&quot;">
