<div>
    ...
    <div class="mx-4">
        ...
        <div>
            <button wire:click="delete({{ $brewing }})" class="bg-tawny rounded mx-auto hover:bg-licorice hover:text-white transition-all duration-300 py-1.5 px-3 flex w-full items-center justify-center my-auto">
