<div>
    ...
    <div class="bg-white sticky sm:top-0 top-12 px-4 py-2.5 flex justify-between items-center shadow-lg z-30">
        ...
        <h2 class="text-xl font-semibold tracking-widest truncate">New Brewing</h2>
        <div class="size-6"></div>
    </div>

    <div class="bg-gray-50 shadow-lg relative z-20">
    ...
    <div class="flex flex-col gap-6 bg-gray-50 rounded p-4 relative z-10">
        <div class="">
            <label class="text-sm font-semibold text-gray-500" for="name">Name</label>
        ...
        <div class="">
            <label class="text-sm font-semibold text-gray-500" for="date_start">Start Date</label>
        ...
        <div class="">
            <label class="text-sm font-semibold text-gray-500" for="note">Notes</label>
